package cn.layku.freeapi.config;
...
/**
 * @packageName: cn.layku.freeapi.config;
 * @name: RestTemplateConfig
 * @description:
 * @author: 董定卓
 * @dateTime: 2020/03/08 11:13
 */
@Configuration
public class RestTemplateConfig {
    ...
    public HttpComponentsClientHttpRequestFactory clientHttpRequestFactory() {
        try {
            ...
            clientHttpRequestFactory.setConnectTimeout(200000); // 连接超时
            clientHttpRequestFactory.setReadTimeout(300000); // 数据读取超时时间
